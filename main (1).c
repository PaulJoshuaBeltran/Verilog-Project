...
//	int color, cidx = 0; // fill color and index
	int color = 0xFF800080; // fill color and index
	...
	while(1) {
		...
		// vertex 0; upper 16 bits is x coord and lower 16 is y coord
		SHAPEFILL_mWriteReg(XPAR_SHAPEFILL_0_S00_AXI_BASEADDR, SHAPEFILL_S00_AXI_SLV_REG3_OFFSET, (218 << 16) | 136);

		// vertex 1
		SHAPEFILL_mWriteReg(XPAR_SHAPEFILL_0_S00_AXI_BASEADDR, SHAPEFILL_S00_AXI_SLV_REG4_OFFSET, (312<< 16) | (231));

		// vertex 2
		SHAPEFILL_mWriteReg(XPAR_SHAPEFILL_0_S00_AXI_BASEADDR, SHAPEFILL_S00_AXI_SLV_REG5_OFFSET, (179<< 16) | (200));
...
//		SHAPEFILL_mWriteReg(XPAR_SHAPEFILL_0_S00_AXI_BASEADDR, SHAPEFILL_S00_AXI_SLV_REG5_OFFSET, ((0) << 16) | (0));
		...
		shapefill_isr_done = 0; // reset the interrupt indicator
		// color setter
		SHAPEFILL_mWriteReg(XPAR_SHAPEFILL_0_S00_AXI_BASEADDR, SHAPEFILL_S00_AXI_SLV_REG2_OFFSET, 0xFFDDFF00);

		// vertex 0; upper 16 bits is x coord and lower 16 is y coord
		SHAPEFILL_mWriteReg(XPAR_SHAPEFILL_0_S00_AXI_BASEADDR, SHAPEFILL_S00_AXI_SLV_REG3_OFFSET, (397 << 16) | 243);

		// vertex 1
		SHAPEFILL_mWriteReg(XPAR_SHAPEFILL_0_S00_AXI_BASEADDR, SHAPEFILL_S00_AXI_SLV_REG4_OFFSET, (451<< 16) | (285));

		// vertex 2
		SHAPEFILL_mWriteReg(XPAR_SHAPEFILL_0_S00_AXI_BASEADDR, SHAPEFILL_S00_AXI_SLV_REG5_OFFSET, (408<< 16) | (335));
...
//		SHAPEFILL_mWriteReg(XPAR_SHAPEFILL_0_S00_AXI_BASEADDR, SHAPEFILL_S00_AXI_SLV_REG5_OFFSET, ((0) << 16) | (0));
		...
		// vertex 1
		SHAPEFILL_mWriteReg(XPAR_SHAPEFILL_0_S00_AXI_BASEADDR, SHAPEFILL_S00_AXI_SLV_REG4_OFFSET, (408<< 16) | (335));

		// vertex 2
		SHAPEFILL_mWriteReg(XPAR_SHAPEFILL_0_S00_AXI_BASEADDR, SHAPEFILL_S00_AXI_SLV_REG5_OFFSET, (355<< 16) | (291));
